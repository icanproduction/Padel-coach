...
import { uploadLogo, removeLogo, updateAppSetting } from '@/app/actions/settings-actions'
...
export function SettingsForm({ appName, logoUrl }: SettingsFormProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-xl border border-border p-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Upload logo untuk ditampilkan di aplikasi. Format: PNG, JPG, WebP, SVG. Maks 2MB.
        </p>
